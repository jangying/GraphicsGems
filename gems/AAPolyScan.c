...
void renderScanline(Vl, Vr, y, object)
	Vertex *Vl,
	*Vr; /* polygon vertices interpolated */
/* at scanline */
...
*/
int Coverage(x) int x; /* left subpixel of pixel */
{
 ...
 * need this mask. )
*/
void computePixelMask(x, mask) int x; /* left subpixel of pixel */
